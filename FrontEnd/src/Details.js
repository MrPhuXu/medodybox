...
function Details({ route, navigation }) {
  ...
  const handlePlay = async () => {
    if (sound) {
      ...
      var url = "http://192.168.2.109:3000/audios/" + baihatc.audio;
      playSound(url);
      setIsPlaying(true);
    }
  };
    ...
    <View style={styles.container}>
      ...
      <Image
        style={{
          ...
          height: PixelRatio.roundToNearestPixel(360),
        }}
        source={{
          uri: "http://192.168.2.109:3000/images/" + baihatc.image,
        }}
      />
...
const styles = StyleSheet.create({
  ...
  container2: {
    flexDirection: "row",
    marginTop: PixelRatio.roundToNearestPixel(120),
    alignItems: "center",
